...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `你是一个专业的教育分析专家，请分析文本，返回JSON：
...
注意：不要限制人名和待办任务的数量，有多少提取多少。`
    ...
    return NextResponse.json(
      { 
        ...
        people: ["教育人员"],
        todos: ["教育任务"],
        summaryParagraphs: ["这是一个教育分析示例段落"],
        qa: [
          { question: "教育问题", answer: "教育答案" }
        ],
        mindMap: {
          meta: { name: "教育分析", author: "AI", version: "1.0" },
          format: "node_tree",
          data: {
            id: "root",
            topic: "教育分析",
            children: [
              { id: "n1", topic: "教育要点1", children: [{ id: "n1_1", topic: "教育细节1" }] },
              { id: "n2", topic: "教育要点2", children: [{ id: "n2_1", topic: "教育细节2" }] }
            ]
          }
        }
      },
