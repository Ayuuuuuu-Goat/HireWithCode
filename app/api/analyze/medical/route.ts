...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `你是一个专业的医学分析顾问，请分析文本，返回JSON：
...
注意：不要限制人名和待办任务的数量，有多少提取多少。`
    ...
    return NextResponse.json(
      { 
        ...
        people: ["医学人员"],
        todos: ["医学任务"],
        summaryParagraphs: ["这是一个医学分析示例段落"],
        qa: [
          { question: "医学问题", answer: "医学答案" }
        ],
        mindMap: {
          meta: { name: "医学分析", author: "AI", version: "1.0" },
          format: "node_tree",
          data: {
            id: "root",
            topic: "医学分析",
            children: [
              { id: "n1", topic: "医学要点1", children: [{ id: "n1_1", topic: "医学细节1" }] },
              { id: "n2", topic: "医学要点2", children: [{ id: "n2_1", topic: "医学细节2" }] }
            ]
          }
        }
      },
