...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `你是一个专业的销售分析助手，请分析文本，返回JSON：
...
注意：不要限制人名和待办任务的数量，有多少提取多少。`
    ...
    return NextResponse.json(
      { 
        ...
        people: ["销售人员"],
        todos: ["销售任务"],
        summaryParagraphs: ["这是一个销售分析示例段落"],
        qa: [
          { question: "销售问题", answer: "销售答案" }
        ],
        mindMap: {
          meta: { name: "销售分析", author: "AI", version: "1.0" },
          format: "node_tree",
          data: {
            id: "root",
            topic: "销售分析",
            children: [
              { id: "n1", topic: "销售要点1", children: [{ id: "n1_1", topic: "销售细节1" }] },
              { id: "n2", topic: "销售要点2", children: [{ id: "n2_1", topic: "销售细节2" }] }
            ]
          }
        }
      },
